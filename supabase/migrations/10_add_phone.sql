-- 10_add_phone.sql
-- Add phone column to bookings and update create_booking RPC

-- 1. Add phone column to public.bookings table if not exists
ALTER TABLE public.bookings ADD COLUMN IF NOT EXISTS phone text;

-- 2. Update create_booking RPC to include phone
